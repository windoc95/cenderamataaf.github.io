    ...
    <div id="background">
        ...
        <div id="page">
            <div id="sidebar">
                ...
                <ul>
                    <li>
                        <span><a href="user_index1.php"><i class="icon-home icon-large"></i>Utama</a></span>
                    </li>
                    <li>
                        <span><a href="user_guitar1.php"><i class=" icon-th-large icon-large"></i>Produk</a></span>
                    </li>

                    <li>
                        <span><a href="user_about1.php"><i class="icon-info-sign icon-large"></i>&nbsp;Tentang Kami</a></span>
                    </li>

                    <li>
                        <span><a href="user_contact1.php"><i class="icon-phone-sign icon-large"></i>Menghubungi Kami</a></span>
                    </li>
                ...
                <div class="hero-unit-table">
                    ...
                    <div id="body">
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr"  method="post">
                            ...
                            <input type="hidden" name="business" value="MANOB@gmail.com" />
